...
class Link
{
     ...
     *
     * @ORM\OneToMany(targetEntity="App\Entity\Click", mappedBy="link")
     */
    private $clicks;
     ...
     * Add click
     *
     * @param \App\Entity\Click $click
     *
     * @return Link
     */
    public function addClick(\App\Entity\Click $click)
    {
        $this->clicks[] = $click;
     ...
     * @param \App\Entity\Click $click
     */
    public function removeClick(\App\Entity\Click $click)
    {
